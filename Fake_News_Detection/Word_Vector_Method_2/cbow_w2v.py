...
model_W2V =Word2Vec(tokenized_corpus, size=10, window=5, min_count=1, workers=5, sg=0,max_vocab_size=10000)


model_W2V.save("cbow_w2v.model")

#model_W2V = gensim.models.Word2Vec.load("cbow_w2v.model")
